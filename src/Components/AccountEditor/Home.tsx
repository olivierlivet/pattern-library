...
const AccountHome = ({ }) => {
    return (
        <AccountWrapper>
            <Box>
                <Heading my={7} color='#66878a' fontWeight='normal' fontSize='3xl' textAlign='center'>Dashboard éditeur partenaire</Heading>
            </Box>
            <Grid
                templateColumns={{
                    base: `300px 1fr`
                    ...
                    <VStack spacing={4} position='sticky' top={10}>
                        <Box borderRadius='10px' bg='brand.pink.300' w='300px' p={10}>
                            <VStack
                                ...
                                spacing={0}
                            >
                                <Text fontSize='7xl' color='white'>34</Text>
                        ...
                        <Box borderRadius='10px' bg='green.200' w='300px' p={10}>
                            <VStack
                                ...
                                spacing={0}
                            >
                                <Text fontSize='7xl' color='white'>234€</Text>
                        ...
                        <Box borderRadius='10px' bg='gray.300' w='300px' p={10}>
                            <VStack
                                ...
                                spacing={0}
                            >
                                <Text fontSize='7xl' color='white'>2,3%</Text>
